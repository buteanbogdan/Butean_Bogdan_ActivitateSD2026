...
// Functie pentru citirea unui singur laptop din fisier (format CSV: id,nrNuclee,pret,model,producator,serie)
Laptop citireLaptopDinFisier(FILE* file) {
    char buffer[100];
    char sep[3] = ",\n";
    Laptop l1;
    l1.id = -1; // Flag in caz de eroare
...
// Cauta pretul total pentru un anumit producator (ex: "Asus", "Dell")
